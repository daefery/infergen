...
| E4.3 | Watch Mode | Done | Local file-watch → live re-scan + regenerate during development. | Depends on E4.1. |
| E4.4 | CI/CD Integrations | Done | GitHub Action + GitLab/CircleCI recipes. PR comment summarizing new/changed events. | Depends on E4.2. |
...
| E7.5 | Onboarding & Templates | Done | `init` templates per stack, example projects, getting-started docs, quickstart < 5 min. | Depends on E0.2, E0.4. |
